...
# imagespec="ghcr.io/flyteorg/flytekit-python-template:mnist-training-latest"
...
def mnist_workflow_gpu(n_epoch: int = 10) -> Tuple[str, th.nn.Sequential]:
    """
    This workflow is identical to CPU variant, except that it runs the training on the GPU.
    """
